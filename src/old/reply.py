...
def format_reply_content_inline(
    original_content: str, sender: str, date_received: datetime
) -> str:
    """
...
def start_replying_to_mail(
    mail: ProccesedMailMessage, reply: str, settings: AccountSettings
) -> bool:
    """
